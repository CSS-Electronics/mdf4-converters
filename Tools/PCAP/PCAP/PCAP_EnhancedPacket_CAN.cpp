...
namespace tools::pcap {
    ...
    PCAP_EnhancedPacket_CAN::PCAP_EnhancedPacket_CAN(CAN_DataFrame_t const& canDataFrame) : data({0}) {
        ...
        std::copy(canDataFrame.DataBytes, canDataFrame.DataBytes + length, data.begin());
